...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    # set pt file name
    last, best = w / 'last.pt', w / 'test4best.pt'
...
def parse_opt(known=False):
    ...
    parser.add_argument('--batch-size', type=int, default=66, help='total batch size for all GPUs')
    ...
    parser.add_argument('--name', default='aigo-tl-train', help='save to project/name')
...
def main(opt, callbacks=Callbacks()):
    ...
    if opt.resume and not check_wandb_resume(opt) and not opt.evolve:  # resume an interrupted run
        ...
        opt.save_dir = str(ROOT / "../tl_train")
